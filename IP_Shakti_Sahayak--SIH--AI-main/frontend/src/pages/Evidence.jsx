 ...
 *
 * The only score shown is cosine similarity against the query embedding,
 * because that is the only score this system computes. Retrieval here is
 * dense vector search over Chroma — there is no lexical/BM25 stage and no
 * cross-encoder rerank, so no column pretends otherwise.
 */
    ...
    <div style={{ display: 'grid', gap: 22 }} className="fade">
      ...
      <div className="stat-strip">
        <Stat
          ...
          hint="How closely the retrieved law matched the question — not how correct the answer is."
        />
        <Stat
      ...
      {d.confidence != null && (
        <div className="card" style={{ padding: '18px 22px' }}>
          <Confidence value={d.confidence} abstained={d.abstained} />
        </div>
      )}
